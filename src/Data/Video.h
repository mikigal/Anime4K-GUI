...
namespace Upscaler {
    ...
    public:
        ...
        TinyProcessLib::Process* UpscalingProcess;
        ...
        Video(std::string name, int duration, uintmax_t size, int width, int height, int frameRate,
            ...
            : Name(std::move(name)), Duration(duration), Size(size), Width(width), Height(height),
              ...
              Path(std::move(path)), Status(status), Progress(progress), Eta(eta), Speed(speed), UpscalingProcess(upscalingProcess) {}
        ...
        Video(const Video& other)
            : Name(other.Name), Duration(other.Duration), Size(other.Size), Width(other.Width),
              ...
              Progress(other.Progress.load()), Eta(other.Eta.load()), Speed(other.Speed.load()), UpscalingProcess(other.UpscalingProcess) {}
        ...
        Video& operator=(const Video& other) {
            if (this != &other) {
                ...
                UpscalingProcess = other.UpscalingProcess;
            }
            return *this;
        }
        ...
        Video(Video&& other) noexcept
            : Name(std::move(other.Name)), Duration(other.Duration), Size(other.Size), Width(other.Width),
              ...
              Speed(other.Speed.load()), UpscalingProcess(other.UpscalingProcess) {}
